                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative">
                                    ...
                                    <textarea name="information" id="information" rows="10"
                                        class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ old('information', $shop->information) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div><input type="radio" name="is_selling" class="mr-2" value="1"
                                            {{ old('is_selling', $shop->is_selling) == 1 ? 'checked' : '' }}>販売中</div>
                                    <div><input type="radio" name="is_selling" class="mr-2" value="0"
                                            {{ old('is_selling', $shop->is_selling) == 0 ? 'checked' : '' }}>停止中</div>
                                </div>
                            </div>
